package com.example.qomposequard
...
import com.example.qomposequard.ui.theme.QomposeQuardTheme
...
fun ComposeQuardApp() {
        ...
        Row(Modifier.weight(1f)){
            ...
            ComposableInfoCard(
                title = "Colomn composable",
                description = "fourth_description\">A layout composable that places its children in a vertical sequence.",
                backgroundColor = Color(0xFFF6EDFF),
                modifier = Modifier.weight(1f)
            )
        }
